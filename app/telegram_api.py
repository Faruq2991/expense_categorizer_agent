...
dispatcher = Dispatcher(bot, None, asyncio.get_event_loop())
...
dispatcher.add_handler(MessageHandler(filters.COMMAND & filters.Regex("^/start$"), start))
dispatcher.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, categorize_expense_telegram))
